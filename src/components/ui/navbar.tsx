        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 py-2">
            <div className="flex w-full justify-between lg:w-auto">
              ...
              >
                <p className="sm:text-3xl text-2xl">🌐</p>
                  ...
                  <li key={index}>
                    ...
                    >
                      <span>
                        {item.name}
                        {item.name === "APIs" && (
                          <span className="text-sm border-1 border-green-500 text-green-500 px-2 ml-2 rounded-md">
                            New
                          </span>
                        )}
                      </span>
                    ...
                    <li key={index}>
                      ...
                      >
                        <span>
                          {item.name}{" "}
                          {item.name === "APIs" && (
                            <span className="text-sm border-1 border-green-500 text-green-500 px-2 rounded-md">
                              New
                            </span>
                          )}
                        </span>
